...
<html>
    <head>
        ...
        <link href="css/font_list.css" rel="stylesheet" type="text/css">
    ...
    <body>
     	...
     	<div id="container"> 
	         <div id="headcontainer">
	         	<jsp:include page="/WEB-INF/jspf/listPage/headcontainer.jsp" />
	         </div>
	         
	         <div id="index_menu_c"> 
	         	<jsp:include page="/WEB-INF/jspf/listPage/menu.jsp" />
	         </div>
	          	...
	          	<div class="content_c"> 
      				<div class="content_left">
      					<div class="content_list_s">
      						<jsp:include page="/WEB-INF/jspf/listPage/leftNavigation.jsp" />
      					</div>
      					<jsp:include page="/WEB-INF/jspf/listPage/contains.jsp" />
	          		</div>
	          	</div>
	         ...
	         <div id="footer">
	             <jsp:include page="/WEB-INF/jspf/listPage/footer.jsp" />
	         </div>
	         
        </div>
        <div class="main-im">
	         	<jsp:include page="/WEB-INF/jspf/listPage/im.jsp" />
	         </div>
    </body>
</html>
